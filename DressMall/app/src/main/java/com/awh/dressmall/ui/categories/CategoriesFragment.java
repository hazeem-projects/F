package com.awh.dressmall.ui.categories;
...
import com.awh.dressmall.MainActivity;
import com.awh.dressmall.R;
import com.awh.dressmall.adapter.CategoryAdapter;
import com.awh.dressmall.model.Category;
...
public class CategoriesFragment extends Fragment {
    ...
    private void insertSampleData() {
        ...
        categories.add(new Category("2", "Baby cloths", ""));
        categories.add(new Category("3", "Denim", ""));
        categories.add(new Category("4", "Cotton Trousers", ""));
        categories.add(new Category("5", "Shirt", ""));
        categories.add(new Category("6", "Jacket", ""));
