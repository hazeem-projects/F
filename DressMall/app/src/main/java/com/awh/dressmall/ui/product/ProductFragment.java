package com.awh.dressmall.ui.product;
...
import com.awh.dressmall.adapter.ProductAdapter;
import com.awh.dressmall.model.Category;
import com.awh.dressmall.model.Product;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        productView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                transaction.replace(R.id.container, new com.awh.dressmall.ui.product.ProductDetailsFragment(product));
